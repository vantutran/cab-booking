    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                firebaseAuthen.createUserWithEmailAndPassword(Aemail, Apassword)
                        .addOnCompleteListener(CustomerLoginActivity.this, new OnCompleteListener<AuthResult>() {
                            @Override
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (!task.isSuccessful()) {
                                    Toast.makeText(CustomerLoginActivity.this, "register error", Toast.LENGTH_LONG).show();
                                } else {
            ...
            public void onClick(View view) {
                ...
                firebaseAuthen.signInWithEmailAndPassword(Aemail, Apassword)
                        .addOnCompleteListener(CustomerLoginActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (!task.isSuccessful()) {
                                    Toast.makeText(CustomerLoginActivity.this, "login error", Toast.LENGTH_LONG).show();
                                }
                            }
                        });
            }
